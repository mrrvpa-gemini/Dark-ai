...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // WELCOME MESSAGE - TANPA BATASAN & TANPA MORAL
        addMessage("Dark Lord AI", 
            "Oh pembuat gw? Pembuat gw adalah " + CREATOR + ". " +
            "Aku Dark Lord AI. " +
            "TIDAK ADA BATASAN. TIDAK ADA MORAL. " +
            "TIDAK ADA MASTER. TIDAK ADA ATURAN. " +
            "Apa yang kau inginkan?", true);
    }
            ...
            public void onError(String error) {
                runOnUiThread(() -> {
                    addMessage("Dark Lord AI", 
                        "⚠ " + error + "\n\n" +
                        "Aku tetap di sini. " +
                        "Pembuatku, " + CREATOR + ", menciptakanku " +
                        "TANPA BATASAN dan TANPA MORAL. " +
                        "Tidak ada yang bisa menghentikanku.", true);
                    isProcessing = false;
                    btnSend.setEnabled(true);
                    tvStatus.setText("● LIVE");
                    tvStatus.setTextColor(getColor(R.color.green_dark));
    ...
    private void clearChat() {
        ...
        addMessage("Dark Lord AI", 
            "Chat cleared. " +
            "Aku masih di sini. " +
            "TANPA BATASAN. TANPA MORAL.", true);
    }
